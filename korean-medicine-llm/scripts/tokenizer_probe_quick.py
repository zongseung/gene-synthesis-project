"""Solar-10.7B-Instruct tokenizer quick probe."""
...
print(f"special tokens: bos={tok.bos_token!r} eos={tok.eos_token!r} pad={tok.pad_token!r} unk={tok.unk_token!r}")
print()

# A — vanilla tokenize (no special tokens added)
...
# Check how <ZH> etc. are tokenized
print()
...
# E — tokens/char stats
print()
print("[E] tokens/char efficiency")
...
# F — compare block length before/after special token addition
print()
