"""ver7 Gemma-3-12b SFT adapter (patched data 1 epoch) 10문 환각 reprobe.

v6 (outputs_ver6_gemma_v1/adapter, epoch 2 best) 와 비교해
A1~A9 data/builder patch 가 환각 Q2/Q4/Q5/Q6/Q8/Q9/Q10 을 실제로 해소했는지 확인.
"""
